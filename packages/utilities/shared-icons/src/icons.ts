...
interface IconProps {
  ...
  width?: string | number;
  label?: string;
  [key: string]: any; // To handle spread props like IconSvgProps
}
...
export const SunIcon = defineComponent({
  ...
  render() {
    const { fill, filled, size, height, width, ...props } = this
      .$props as IconProps;
    if (filled) {
      return h(
        "svg",
...
export const MailIcon = defineComponent({
  ...
  render() {
    const { fill, size, height, width, ...props } = this.$props as IconProps;
    return h(
      "svg",
      {
        height: size || height || 24,
...
export const VolumeUpIcon = defineComponent({
  props: {
    fill: String,
    size: [String, Number],
    height: [String, Number],
    ...
    return h(
      ...
      [
        h(
          ...
          [
            h("path", { d: "M6.918 14.854l2.993-3.889 3.414 2.68 2.929-3.78" }),
            h("path", {
    ...
    return h(
      ...
      [
        h(
          ...
          [h("path", { d: "M6 12h12" }), h("path", { d: "M12 18V6" })],
        ),
      ],
    );
  },
...
export const ChevronDownBoldIcon = defineComponent({
  props: {
    fill: String,
    size: [String, Number],
    height: [String, Number],
...
export const FlashIcon = defineComponent({
  props: {
    fill: String,
    size: [String, Number],
    height: [String, Number],
...
export const TagUserIcon = defineComponent({
  props: {
    fill: String,
    size: [String, Number],
    height: [String, Number],
