...
/**
 * The veroUI config.
 * @see https://veroui.com/docs/customization/customize-theme
 */
export type VeroUIPluginConfig = {
  /**
  ...
  prefix?: string;
  /**
   * If true, the common veroui colors (e.g. "blue", "green", "purple") will not be extended on the theme.
   * @default false
   */
